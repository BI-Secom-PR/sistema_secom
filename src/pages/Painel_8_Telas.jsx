...
import Trends from "../components/Trends" // Import the Trends component
import Demografico from "../components/Demografico" // Import the Demografico component
...
const Painel_8_Telas = () => {
  ...
  // Função para detectar telas ultra-wide (acima de 6000px)
  useEffect(() => {
    const checkScreenWidth = () => {
      setIsUltraWideScreen(window.innerWidth > 6000);
    };
  ...
  return (
    <>
      ...
      {!loading && !error && (
        <>
          {isUltraWideScreen ? (
        // Layout para telas acima de 6000px
        <div className="d-flex" style={{ gap: "30px", height: "calc(100vh - 150px)" }}>
            {/* Lado esquerdo - 50% da tela */}
            ...
            <div style={{ 
                flex: "3", 
                minHeight: "500px",  // Added explicit minimum height
                height: "65vh"       // Added proportional height 
            }}>
                <ErrorBoundary fallback={<ComponentFallback componentName="Gráfico Comparativo" onRetry={handleManualRetry} />}>
            ...
            // Layout padrão para telas menores (original)
            <>
              <ErrorBoundary fallback={<ComponentFallback componentName="Cards" onRetry={handleManualRetry} />}>
                <Cards startDate={startDate} endDate={endDate} selectedCampaign={selectedCampaign} />
              </ErrorBoundary>
