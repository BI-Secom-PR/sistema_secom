...
const VeiculosHistoricos = ({ startDate, endDate, selectedCampaign }) => {
  ...
  const colors = {
    ...
    secondary: isDarkMode ? '#94a3b8' : '#3b3b3b',
    border: isDarkMode ? '#585858' : '#E2E8F0',
    background: isDarkMode ? '#292929' : '#F8FAFC',
    lightBg: isDarkMode ? '#3f3f3f' : '#F1F5F9',
    cardBg: isDarkMode 
      ? 'linear-gradient(145deg, #242424, #272727)'
  ...
  const styles = {
    ...
    loader: {
      ...
      border: isDarkMode 
        ? '5px solid rgba(226, 232, 240, 0.2)'
        : '5px solid rgba(79, 70, 229, 0.2)',
      borderRadius: '50%',
  ...
  const getIcon = (platform) => {
    // Adjust icon color based on theme when needed
    switch (platform.toLowerCase()) {
      ...
      case "tiktok": return <img src={tiktokLogo} alt="TikTok Logo" width={isMobile ? "20" : "24"} height={isMobile ? "20" : "24"} style={isDarkMode ? {filter: 'invert(1)'} : {}} />;
      ...
      <div style={styles.header}>
        ...
        {selectedCampaign && (
          <div style={{
            ...
            fontWeight: '500',
            color: colors.primary,
            backgroundColor: `${colors.primary}${isDarkMode ? '20' : '10'}`,
              ...
              <div style={styles.platformHeader}>
                <motion.div 
                  style={{
                    ...
                    backgroundColor: `${platformColor}${isDarkMode ? '20' : '15'}`
                  }}
              ...
              <div style={styles.metricsGrid}>
                {["CPM", "CPV", "CPC", "CTR", "VTR"].map((kpi) => (
                  <motion.div 
                    ...
                    whileHover={{ scale: isMobile ? 1 : 1.03, boxShadow: isMobile 
                      ? 'none' 
                      : isDarkMode 
